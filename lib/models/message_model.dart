...
// YOU - current user
final User currentUser = User(id: 0, name: 'Amit Shanbhag', imageUrl: 'assets/images/greg.jpg');

// USERS
final User greg = User(id: 1, name: 'Greg', imageUrl: '');
...
// FAVORITE CONTACTS
List<User> favorites = [sam, steven, olivia, john, greg, steven, olivia, john, greg];
